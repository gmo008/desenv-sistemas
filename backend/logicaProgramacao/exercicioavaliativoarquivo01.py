#01 eu, como dono de uma padaria quero um sistema de onde eu possa adastrar meus produtos,alem de poder listar, alterar em caso de error, 
#e excluir quando acabar o estoque.Quero tambem que tenha um menu onde eu possa ver as opções possiveis

#03 explique porque quando tenha mais de um atributo(variável), torna-se dificil/complicado o uso de arquivos txt para guardar informações
